...
//database connection
mongoose.connect("mongodb+srv://urmail2jen:098765@cluster0.ndqtanv.mongodb.net/Ecommerce");
...
//pass the multer storage configuration
...
//api for popular in women section from db
...
app.post('/login',async(req,res)=>{
    ...
    //console.log('user response from mongo: ', res.json())
    if(user){
        // console.log('req ', req.body.password, 'mongo res', user.password)
...
//api to add item to cart and db
...
//api to remove from cart and db
